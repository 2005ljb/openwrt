...
static const struct rb_board_info rb92x_boards[] __initconst = {
        ...
        RB_BOARD_INFO("922UAGS-5HPacD", RB92X_FLAG_USB | RB92X_FLAG_PCIE),
};
...
static void __init rb922gs_setup(void)
{
	...
	if (flags & RB92X_FLAG_USB) {
		gpio_request_one(RB922_GPIO_USB_POWER,
			GPIOF_OUT_INIT_LOW | GPIOF_EXPORT_DIR_FIXED, "USB power");
	...
	ath79_register_gpio_keys_polled(-1, RB922_KEYS_POLL_INTERVAL,
		ARRAY_SIZE(rb922gs_gpio_keys), rb922gs_gpio_keys);
}
